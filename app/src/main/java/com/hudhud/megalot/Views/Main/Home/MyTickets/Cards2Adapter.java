...
public class Cards2Adapter extends RecyclerView.Adapter<Cards2Adapter.ViewHolder> {

    Context context;
    ArrayList<Card> cards;
    MyTicketsFragment myTicketFragment;
    private DecimalFormat formatter = new DecimalFormat("#0.00");

    public Cards2Adapter(ArrayList<Card> cards, MyTicketsFragment myTicketFragment) {
        this.cards = cards;
