package com.hudhud.megalot.AppUtils.Helpers;
...
//    public static void setSliderTimer2(int delay, ViewPager2 viewPager, ImagesSliderAdapter imagesSliderAdapter){
//        Handler handler = new Handler();
//        final Runnable[] runnable = new Runnable[1];
//
//        handler.postDelayed(new Runnable() {
...
//                int pagerIndex = viewPager.getCurrentItem();
//                pagerIndex++;
//                if (pagerIndex >= imagesSliderAdapter.getCount()){
//                    pagerIndex = 0;
//                }
...
//        },delay);
//    }
//    public static void setSliderTimer2(int delay, ViewPager2 viewPager, PackageSliderAdapter imagesSliderAdapter){
//        Handler handler = new Handler();
//        final Runnable[] runnable = new Runnable[1];
//
//        handler.postDelayed(new Runnable() {
